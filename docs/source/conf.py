# -*- coding: utf-8 -*-
#
# cottonformation documentation build configuration file, created by
...
version = cottonformation.__version__
# The full version, including alpha/beta/rc tags.
release = cottonformation.__version__
...
htmlhelp_basename = 'cottonformationdoc'
...
latex_documents = [
    (master_doc, 'cottonformation.tex', 'cottonformation Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'cottonformation', 'cottonformation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cottonformation', 'cottonformation Documentation',
     author, 'cottonformation', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from cottonformation.docs import doc_data
except:
    doc_data = dict()
...
package_name = cottonformation.__name__

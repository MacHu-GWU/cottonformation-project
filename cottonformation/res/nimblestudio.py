...
class PropLaunchProfileStreamConfigurationSessionStorage(Property):
    ...
    - ``rp_Mode``: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-nimblestudio-launchprofile-streamconfigurationsessionstorage.html#cfn-nimblestudio-launchprofile-streamconfigurationsessionstorage-mode
    ...
    rp_Mode: typing.List[TypeHint.intrinsic_str] = attr.ib(
        default=None,
    ...
    p_Root: typing.Optional[dict] = attr.ib(
        default=None,
...
class StreamingImage(Resource):
    ...
    rp_Ec2ImageId: TypeHint.intrinsic_str = attr.ib(
        ...
        validator=attr.validators.instance_of(TypeCheck.intrinsic_str_type),
        metadata={
            AttrMeta.PROPERTY_NAME: "Ec2ImageId",
            AttrMeta.DATA: {
...
class LaunchProfile(Resource):
    ...
    rp_Ec2SubnetIds: typing.List[TypeHint.intrinsic_str] = attr.ib(
        ...
        validator=attr.validators.deep_iterable(member_validator=attr.validators.instance_of(TypeCheck.intrinsic_str_type), iterable_validator=attr.validators.instance_of(list)),
        metadata={
            AttrMeta.PROPERTY_NAME: "Ec2SubnetIds",
            AttrMeta.DATA: {
                "UpdateType": 'Immutable',
                "Required": True,
                "Type": 'List',
    ...
    rp_LaunchProfileProtocolVersions: typing.List[TypeHint.intrinsic_str] = attr.ib(
        ...
        validator=attr.validators.deep_iterable(member_validator=attr.validators.instance_of(TypeCheck.intrinsic_str_type), iterable_validator=attr.validators.instance_of(list)),
        metadata={
            AttrMeta.PROPERTY_NAME: "LaunchProfileProtocolVersions",
            AttrMeta.DATA: {
                "UpdateType": 'Mutable',
                "Required": True,
                "Type": 'List',
    ...
    rp_StreamConfiguration: typing.Union['PropLaunchProfileStreamConfiguration', dict] = attr.ib(
        ...
        metadata={
            AttrMeta.PROPERTY_NAME: "StreamConfiguration",
            AttrMeta.DATA: {
                "UpdateType": 'Mutable',
                "Required": True,
    ...
    rp_StudioComponentIds: typing.List[TypeHint.intrinsic_str] = attr.ib(
        ...
        validator=attr.validators.deep_iterable(member_validator=attr.validators.instance_of(TypeCheck.intrinsic_str_type), iterable_validator=attr.validators.instance_of(list)),
        metadata={
            AttrMeta.PROPERTY_NAME: "StudioComponentIds",
            AttrMeta.DATA: {
                "UpdateType": 'Mutable',
                "Required": True,
                "Type": 'List',
...
class StudioComponent(Resource):
    ...
    p_Ec2SecurityGroupIds: typing.List[TypeHint.intrinsic_str] = attr.ib(
        ...
        metadata={
            AttrMeta.PROPERTY_NAME: "Ec2SecurityGroupIds",
            AttrMeta.DATA: {
                "UpdateType": 'Mutable',
                "Required": False,
                "Type": 'List',
    ...
    p_InitializationScripts: typing.List[typing.Union['PropStudioComponentStudioComponentInitializationScript', dict]] = attr.ib(
        ...
        metadata={
            AttrMeta.PROPERTY_NAME: "InitializationScripts",
            AttrMeta.DATA: {
                "UpdateType": 'Mutable',
                "Required": False,
                "Type": 'List',
    ...
    p_ScriptParameters: typing.List[typing.Union['PropStudioComponentScriptParameterKeyValue', dict]] = attr.ib(
        ...
        metadata={
            AttrMeta.PROPERTY_NAME: "ScriptParameters",
            AttrMeta.DATA: {
                "UpdateType": 'Mutable',
                "Required": False,
                "Type": 'List',
    ...
    p_Subtype: TypeHint.intrinsic_str = attr.ib(
        ...
        validator=attr.validators.optional(attr.validators.instance_of(TypeCheck.intrinsic_str_type)),
        metadata={
            AttrMeta.PROPERTY_NAME: "Subtype",
            AttrMeta.DATA: {
                "UpdateType": 'Immutable',
                "Required": False,
                "PrimitiveType": 'String',
...
class Studio(Resource):
    ...
    rp_AdminRoleArn: TypeHint.intrinsic_str = attr.ib(
        ...
        validator=attr.validators.instance_of(TypeCheck.intrinsic_str_type),
        metadata={
            AttrMeta.PROPERTY_NAME: "AdminRoleArn",
            AttrMeta.DATA: {
                "UpdateType": 'Mutable',
                "Required": True,
                "PrimitiveType": 'String',
    ...
    rp_StudioName: TypeHint.intrinsic_str = attr.ib(
        ...
        validator=attr.validators.instance_of(TypeCheck.intrinsic_str_type),
        metadata={
            AttrMeta.PROPERTY_NAME: "StudioName",
            AttrMeta.DATA: {
                "UpdateType": 'Immutable',
                "Required": True,
                "PrimitiveType": 'String',
    ...
    rp_UserRoleArn: TypeHint.intrinsic_str = attr.ib(
        ...
        validator=attr.validators.instance_of(TypeCheck.intrinsic_str_type),
        metadata={
            AttrMeta.PROPERTY_NAME: "UserRoleArn",
            AttrMeta.DATA: {
                "UpdateType": 'Mutable',
                "Required": True,
                "PrimitiveType": 'String',
    ...
    p_StudioEncryptionConfiguration: typing.Union['PropStudioStudioEncryptionConfiguration', dict] = attr.ib(
        ...
        metadata={
            AttrMeta.PROPERTY_NAME: "StudioEncryptionConfiguration",
            AttrMeta.DATA: {
                "UpdateType": 'Mutable',
                "Required": False,
